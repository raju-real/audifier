...
<div class="middle-sec">
    ...
    <section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2 pt-0">
                <h4 class="mb-sm-0 font-size-28">Organization List</h4>
                <div class="page-title-right">
                    <a href="{{ route('admin.organizations.create') }}" class="bg-orange btn-hover back-all text-white rounded-pill">
     ...
     <div class="row all-field-pannel mt-2">
        <div class="col-12 search-left">
          ...
          <div class="accordion-item border-0">
                    ...
                    <div id="collapseSearch" class="accordion-collapse zindexall collapse {{ request()->query() ? 'show' : '' }}"
                            ...
                            <form method="GET" action="{{ route('admin.organizations.index') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 mt-0">
                                        <button type="submit" class="btn height-48 bg-orange btn-hover text-white">Search</button>
                                    </div>
                                </div>
                            </form>
                        </div>
