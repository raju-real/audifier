...
<section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2">
                <h4 class="mb-sm-0 font-size-28">Financial Year Add/Edit</h4>
                <div class="page-title-right">
                    <a href="{{ route('admin.financial-years.index') }}" class="bg-orange btn-hover back-all text-white rounded-pill">
