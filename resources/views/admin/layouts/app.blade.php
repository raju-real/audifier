...
<head>
    ...
    <link href="{{ asset('assets/admin/fontawesome/css/all.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div id="layout-wrapper">
        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex sear-top-area">
                    <div class="global-search-top">
                        <div class="global-ser-inner">
                            <span><i class="fa-solid fa-magnifying-glass"></i></span>
                            <input type="text"  class="form-control-plaintext" placeholder="Search">
                        </div>
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <button type="button" class="profile-top btn header-item waves-effect">
        ...
        <div class="main-content">
            <div class="page-content {{ segmentOne() !== 'dashboard' ? 'bg-main' : '' }}">
    ...
    const myBarChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [80, 150, 50, 70, 120, 140, 120, 120, 150, 140, 150, 120],
