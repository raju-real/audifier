...
<section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2">
                <h4 class="mb-sm-0 font-size-28">Audit Step List</h4>
                <div class="page-title-right">
                    <a href="{{ route('admin.audit-steps.create') }}" class="bg-orange btn-hover back-all text-white rounded-pill">
      ...
      <div class="row all-field-pannel">
        <div class="col-12">
              <div class="card bg-none box-shadow-none">
                ...
                <table class="table table-striped table-bordered bg-white mb-0 text-nowrap">
                            ...
                            @forelse($steps as $step)
                                <tr data-id="{{ $step->id }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn bg-orange  btn-sm text-white" href="{{ route('admin.question-list',$step->slug) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Question List">
