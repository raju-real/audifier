...
<section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2">
                <h4 class="mb-sm-0 font-size-28">Audit Step Add/Edit</h4>
                <div class="page-title-right">
                    <a href="{{ route('admin.audit-steps.index') }}" class="bg-orange btn-hover back-all text-white rounded-pill">
    ...
    <!--            <div class="page-title-right">-->
    <!--                <a href="{{ route('admin.audit-steps.index') }}" class="btn btn-sm btn-outline-primary">-->
    <!--                    <i class="fa fa-arrow-circle-left"></i> Back-->
    <!--                </a>-->
    <!--            </div>-->
    <!--        </div>-->
...
@push('js')
    ...
    let config = {
        toolbar: [
            ['Bold', 'Italic', 'Strike', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'NumberedList', 'BulletedList', '-', 'Maximize'], // 'Maximize' button added
        ]
    };
