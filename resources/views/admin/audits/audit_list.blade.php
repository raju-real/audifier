...
@section('content')
    <section class="middle-sec">
        ...
        <div class="search-top-pannel">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select name="financial_year" class="form-control slim-select">
                                                    <option value=""
                                                        {{ !isset(request()->financial_year) ? 'selected' : '' }}>Financial
                                                        Year
                                                    </option>
            ...
            <div class="add-btn-saerch">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <!--<h4 class="mb-sm-0 font-size-18">Audit List</h4>-->
                    <div class="page-title-right">
                        <a href="{{ route('admin.audits.create') }}" class="btn text-white bg-orange btn-hover">
                                    ...
                                    @forelse($audits as $audit)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="checkbox" id="audit-{{ $loop->index + 1 }}"
                                                    class="audit-status" data-id="{{ $audit->id }}" switch="bool"
