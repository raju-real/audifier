...
<section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2">
                <h4 class="mb-sm-0 font-size-28">Audit Add/Edit</h4>
                ...
                <div class="card-body p-17">
                    <form action="{{ $route }}" method="POST" id="prevent-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Start Date {!! starSign() !!}</label>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" name="start_date" class="form-control datepicker brder-end-0"
                                                autocomplete="off"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" name="end_date" class="form-control datepicker brder-end-0"
                                                autocomplete="off"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="reference_document"
                                        class="form-control file-list {{ hasError('reference_document') }}"
