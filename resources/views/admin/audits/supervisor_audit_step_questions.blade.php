                            ...
                            <tbody>
                                @forelse($step_info->audit_step_questions as $index => $step_question)
                                    <tr>
                                        ...
                                        <td>
                                            @if (questionHasForm($step_info->audit_step_info->id, $step_question->question->id))
                                                @if (auditFormAnswer($step_info->audit_id, $step_info->audit_step_info->id, $step_question->question->id))
                                                    <a href="{{ route('admin.supervisor-show-audit-form', encrypt_decrypt(responseId($step_info->audit_id, $step_info->audit_step_info->id, $step_question->question->id), 'encrypt')) }}"
