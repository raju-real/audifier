...
<section class="search-top-pannel">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between w-100 p24-14 pb-2">
                <h4 class="mb-sm-0 font-size-28">Site Settings</h4>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    <label class="form-label d-flex align-items-center justify-content-between">
                                        ...
                                        @if(isset(siteSettings()['logo']) && file_exists(siteSettings()['logo']))
                                            <button type="button"
                                                    class="custom-badge border-0 bg-orange btn-hover view-image"
                                    ...
                                    <input type="file" name="logo" class="file-list form-control {{ hasError('logo') }}"
                                           accept=".jpg, .jpeg, .png">
                                    @error('logo')
                                    {!! displayError($message) !!}
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="favicon" class="form-control file-list {{ hasError('favicon') }}"
                                           accept=".png">
                                    @error('favicon')
                                    {!! displayError($message) !!}
                                    @enderror
