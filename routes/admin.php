...
Route::group(['as' => 'admin.', 'middleware' => ['auth', '2fa.verified']], function () {
    ...
    Route::controller(AuditorActivityController::class)->group(function () {
        ...
        // Auditor Dynamic Form
        Route::get('auditor-open-form', 'openForm')->name('auditor-open-form');
        Route::post('auditor-submit-form/{form_id}', 'submitForm')->name('auditor-submit-form');
    });
    // ===================================================================
    ...
    Route::controller(SupervisorActivityController::class)->group(function () {
        ...
        Route::get('supervisor-ushow-audit-form/{id}', 'showAuditForms')->name('supervisor-show-audit-form');
    });
    // ===================================================================
    ...
    Route::middleware('administrator')->group(function () {
        ...
        Route::controller(AuditController::class)->group(function () {
            ...
            Route::get('show-audit-form/{id}', 'showAuditForms')->name('show-audit-form');
        });
        // Settings
